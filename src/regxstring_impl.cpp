...
#include "../include/regxstring_impl.h"
...
__CRegxString::__Ret __CRegxString::processSlash(bool bNode, __ParseData &pdata)
{
    ...
    {
    case 'd':
        set = New<__Charset>("0123456789", true);
        break;
    case 'D':
        set = New<__Charset>("0123456789", false);
        break;
    case 's':
        set = New<__Charset>(/*"\f\n\r\v"*/ "\t ", true);
        break;
